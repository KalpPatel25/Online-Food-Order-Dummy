...
//    }
	...
	public Restaurant(String restaurantId,List<Item> itemList, Boolean status, String username, String restaurantType, String restaurantDesc, String restaurantName, String restaurantAddress, long phoneNumber, String restaurantImageUrl,boolean addToFav) {
...
//        this.status = "Disable";
	...
	public void setUsername(String ownerUserId) {
		this.username = ownerUserId;
	}
