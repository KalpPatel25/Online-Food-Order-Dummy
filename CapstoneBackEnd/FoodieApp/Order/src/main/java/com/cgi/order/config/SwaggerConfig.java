...
public class SwaggerConfig {
    ...
    public Docket productApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.cgi.order"))
                .build()
                .apiInfo(setDetails())
    ...
    public ApiInfo setDetails()
    {
        ...
        apibuild.title("OrderService App").version("Ver 1.1").description("This app is used to provide Order endpoints")
                .license("Kalp@cgi.com");
